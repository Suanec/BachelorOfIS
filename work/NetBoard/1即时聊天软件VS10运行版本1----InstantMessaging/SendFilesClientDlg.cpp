...
//	CString strLength;
//	if( dwLength > pow( 1024.0, 3 ) )
//	{
//		float fLength = dwLength / pow( 1024.0, 3 );
//		strLength.Format( "%.2fGB", fLength );
//	}
//	else if( dwLength > pow( 1024.0, 2 ) )
//	{
//		float fLength = dwLength / pow( 1024.0, 2 );
...
//				if( dwReceived > pow( 1024.0, 3 ) )
//				{
//					float fReceived = dwReceived / pow( 1024.0, 3 );
//					strReceived.Format( "%.2fGB", fReceived );
//				}
//				else if( dwReceived > pow( 1024.0, 2 ) )
//				{
//					float fReceived = dwReceived / pow( 1024.0, 2 );
...
//				CString strSpeed;
//				if( fSpeed > pow( 1024.0, 2 ) )
//				{
//					float fSpeed1 = fSpeed / pow( 1024.0, 2 );
