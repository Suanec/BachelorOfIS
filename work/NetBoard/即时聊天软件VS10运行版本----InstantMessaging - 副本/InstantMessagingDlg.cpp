...
BEGIN_MESSAGE_MAP(CInstantMessagingDlg, CDialog)
	...
	ON_MESSAGE( WM_SHELLNOTIFY, OnShellNotifyProcL )
	ON_MESSAGE( WM_HOTKEY, OnHotkeyL )
	ON_COMMAND(IDM_WHITEBOARD, OnWhiteboard)

	ON_MESSAGE( MM_WIM_OPEN, WaveInOpenL )
	ON_MESSAGE( MM_WIM_DATA, WaveInDataL )
	ON_MESSAGE( MM_WIM_CLOSE, WaveInCloseL )
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
